...
#define ENBGAMEID_SKYRIMSE		0x10000006
...
EEXPORT BOOL	ENBGetParameterA(const char *filename, const char *category, const char *keyname, ENBParameter *outparam);
...
EEXPORT BOOL	ENBSetParameterA(const char *filename, const char *category, const char *keyname, ENBParameter *inparam);
